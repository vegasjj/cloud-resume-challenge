...
I designed and built a stateless web application in Azure backed by a NoSQL database and exposed to clients through a Python REST serverless API. To ensure reliability, I implemented a monitoring and alerting system that tracks API performance and triggers email/push notifications on anomalies.
