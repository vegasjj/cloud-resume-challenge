...
- [Local Development Environment details](#local-development-environment-details)
  ...
  - [Setting Up Azure Functions Core Tools](#setting-up-azure-functions-core-tools)
  - [Setting Up the Azure Functions Extension for VS Code](#setting-up-the-azure-functions-extension-for-vs-code)
- [Setting Up the API](#setting-up-the-api)
  - [Setting Up Compute and Storage](#setting-up-compute-and-storage)
    - [The App Service Plan](#the-app-service-plan)
    - [The Storage Account](#the-storage-account)
    - [The Function App](#the-function-app)
  - [Setting Up the Database](#setting-up-the-database)
    - [Setting Up the Cosmos DB Account](#setting-up-the-cosmos-db-account)
    - [Setting Up the Table](#setting-up-the-table)
    - [Setting Up the Entity](#setting-up-the-entity)
  - [Setting Up Authentication Between the Database and Function App](#setting-up-authentication-between-the-database-and-function-app)
  - [Setting Up the Azure Function](#setting-up-the-azure-function)
  - [Locally testing the `visitor_counter` API](#locally-testing-the-visitor_counter-api)
  - [Packing the function files for deployment](#packing-the-function-files-for-deployment)
...
- [Setting Up the GitHub Actions Workflow](#setting-up-the-github-actions-workflow)
  ...
  - [Executing the `create-entity-module` app](#executing-the-create-entity-module-app)
  - [Upload and Setup the Visitor Counter API](#upload-and-setup-the-visitor-counter-api)
- [Setting Up Monitoring and Notifications](#setting-up-monitoring-and-notifications)
  - [Setting Up Logs and Metrics](#setting-up-logs-and-metrics)
    - [The Log Analytics Workspace](#the-log-analytics-workspace)
    - [The Application Insights Instance](#the-application-insights-instance)
  - [Setting Up Alert Rules](#setting-up-alert-rules)
    - [The Action Group](#the-action-group)
    - [The Average Failure Count Alert](#the-average-failure-count-alert)
    - [The Unusual Invocation Number Rule](#the-unusual-invocation-number-rule)
    - [The Unusual Average Duration Rule](#the-unusual-average-duration-rule)
  - [Setting Up Notifications](#setting-up-notifications)
    - [Prerequisites for Slack Integration](#prerequisites-for-slack-integration)
    - [The Slack API Connection](#the-slack-api-connection)
    - [Setting Up the Logic App Workflow](#setting-up-the-logic-app-workflow)
    - [Setting Up the Logic App Trigger](#setting-up-the-logic-app-trigger)
    - [Setting Up the Logic App Action](#setting-up-the-logic-app-action)
  - [Locally Testing Terraform Resources for Monitoring](#locally-testing-terraform-resources-for-monitoring)
  - [Unmanaged Autogenerated Alert Ruled](#unmanaged-autogenerated-alert-ruled)
